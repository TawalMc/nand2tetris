...
class SymbolTable:
    def __init__(self):
        ...
        self.__symbol_table_name = ""
        self.__kind_count = {Kind.STATIC: 0, Kind.ARG: 0, Kind.FIELD: 0, Kind.VAR: 0}
    ...
    def update_symbol_table_name(self, table_name: str):
        self.__symbol_table_name = table_name

    def is_key(self, key: str):
        return bool(key in self.__symbol_table)

    def symbol_table_name(self):
        return self.__symbol_table_name
